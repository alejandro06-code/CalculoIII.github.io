...
- Las cuentas principales y los perfiles `admin` pueden ver administracion e historial, pero solo las cuentas principales pueden asignar perfiles, quitar permisos, sincronizar usuarios, borrar cuentas o eliminar historial.
